...
app.get('/', (req, res) => res.send('<p>Hello ImmersityXR!</p><p>Database status: ' + status + '</p><a href="/api-docs">API Docs</a>'));
...
let server = app.listen(port, () => console.log(`ImmersityXR portal backend listening on port ${port}!`));
